...
def main():
    opath = '/mnt/gpid08/users/albert.dominguez/data/chr1/windowed'
    ...
    for which_set in ['train', 'valid']:
        ...
        h5f = h5py.File(f'{opath}/{which_set}_2gen_avg_founders.h5', 'w')
