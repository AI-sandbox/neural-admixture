...
python3 launch_fit.py --wandb_log 1 --multihead 1 --deep_encoder 1 --activation relu --display_logs 0 --batchnorm 1 --dropout 0 --l2_penalty 0.01 --learning_rate 0.0001 --batch_size 200 --k 7 --epochs 10 --decoder_init admixture --loss bce --mask_frac 1 --optimizer adam --save_every 50 --save_dir /mnt/gpid08/users/albert.dominguez/weights/chr22 --chr 22 --shuffle 1 --min_k 7 --max_k 7 --pooling 1 --alternate 0 --hidden_size 512 --linear 1 --init_path /home/usuaris/imatge/albert.dominguez/ADMIXTURE/gen0_2_chr22.7.P --freeze_decoder 1
